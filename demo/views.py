...
from .serializers import PeopleSerializer, PeopleModelSerializer


# Make a API for People model
...
class PeopleDetailApiView(APIView):
    ...
    # Private update data based on model
